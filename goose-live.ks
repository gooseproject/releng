...
repo --name=GoOSe --baseurl=http://koji.gooselinux.org/releases/6/Everything/$arch/os/
# To include updates, use the following "repo" (enabled by default)
#repo --name=updates --baseurl=http://koji.gooselinux.org/updates/6/$arch/

# To compose against sketchy, use the following "repo" (disabled by default)
#repo --name=sketchy --baseurl=http://koji.gooselinux.org/releases/sketchy/<alpha-release>/Everything/$arch/os/
